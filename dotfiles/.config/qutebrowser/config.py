...
c.url.default_page = '/home/dessasin/.config/qutebrowser/startpage.html'
c.url.start_pages="/home/dessasin/.config/qutebrowser/startpage.html"
...
# qutebrowser`.
# Type: Dict
c.url.searchengines = {'DEFAULT':'https://duckduckgo.com/?q={}', 'dg':'https://duckduckgo.com/?q={}','go': 'https://www.google.com/search?q={}'}

# Text color of the completion widget. May be a single color to use for
# all columns or a list of three colors, one for each column.
# Type: List of QtColor, or QtColor
c.colors.completion.fg = ['#84858b', 'white', 'white']

# Background color of the completion widget for odd rows.
# Type: QssColor
c.colors.completion.odd.bg = '#060608'

# Background color of the completion widget for even rows.
# Type: QssColor
c.colors.completion.even.bg = '#060608'

# Foreground color of completion widget category headers.
# Type: QtColor
c.colors.completion.category.fg = '#fad590'

# Background color of the completion widget category headers.
# Type: QssColor
c.colors.completion.category.bg = '#0d0e14'

# Top border color of the completion widget category headers.
# Type: QssColor
c.colors.completion.category.border.top = '#0d0e14'

# Bottom border color of the completion widget category headers.
# Type: QssColor
c.colors.completion.category.border.bottom = '#0d0e14'

# Foreground color of the selected completion item.
# Type: QtColor
c.colors.completion.item.selected.fg = '#ffb52a'

# Background color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.bg = '#131520'

# Foreground color of the matched text in the selected completion item.
# Type: QtColor
c.colors.completion.item.selected.match.fg = '#ffc65c'

# Foreground color of the matched text in the completion.
# Type: QtColor
c.colors.completion.match.fg = '#ffc65c'
...
# Type: QssColor
c.colors.downloads.bar.bg = '#060608'

# Background color for downloads with errors.
# Type: QtColor
c.colors.downloads.error.bg = '#bd2c40'
...
# Type: QssColor
c.colors.messages.info.bg = '#060608'

# Background color of the statusbar.
# Type: QssColor
c.colors.statusbar.normal.bg = '#060608'

# Foreground color of the statusbar in insert mode.
# Type: QssColor
c.colors.statusbar.insert.fg = '#223022'

# Background color of the statusbar in insert mode.
# Type: QssColor
c.colors.statusbar.insert.bg = '#98be65'

# Background color of the statusbar in passthrough mode.
# Type: QssColor
c.colors.statusbar.passthrough.bg = '#060608'

# Background color of the statusbar in command mode.
# Type: QssColor
c.colors.statusbar.command.bg = '#060608'

# Foreground color of the URL in the statusbar when there's a warning.
# Type: QssColor
c.colors.statusbar.url.warn.fg = '#ffb52a'

# Background color of the tab bar.
# Type: QssColor
c.colors.tabs.bar.bg = '#060608'

# Background color of unselected odd tabs.
# Type: QtColor
c.colors.tabs.odd.bg = '#131520'

# Background color of unselected even tabs.
# Type: QtColor
c.colors.tabs.even.bg = '#0d0e14'

# Background color of selected odd tabs.
# Type: QtColor
c.colors.tabs.selected.odd.bg = '#141620'

# Background color of selected even tabs.
# Type: QtColor
c.colors.tabs.selected.even.bg = '#14151d'

# Background color of pinned unselected odd tabs.
# Type: QtColor
c.colors.tabs.pinned.odd.bg = '#060608'

# Background color of pinned unselected even tabs.
# Type: QtColor
c.colors.tabs.pinned.even.bg = '#060608'
...
# Type: Font
c.fonts.completion.entry = '10pt "Fira Code"'

# Font used for the debugging console.
# Type: Font
c.fonts.debug_console = '10pt "Fira Code"'
